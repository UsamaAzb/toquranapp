...
class StudentDisciplinePointsController extends Controller
{
    /**
     * Display a listing of the teacher's subjects.
     */
    public function get_discipline_points(Request $request)
    {
        ...
        if ((Auth::check()) && (Auth::user()->hasRole('student'))) {
            ...
            return view('student.DisciplinePoints.index', compact('show_bar', 'breadcrumb_links', 'student_id', 'student'));
        } else {
