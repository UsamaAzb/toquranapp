...
- Islamic Studies/Quran Literature service+subject patch: `database/manual/patches/2026-06-21-add-islamic-studies-quran-literature-services-subjects.sql` (not executed in production until backup/evidence and exact approval)
