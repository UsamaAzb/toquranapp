...
| 2026-06-21 | Islamic Studies and Quran Literature were approved as selected-only child-facing services and LMS subjects; the app code and guarded manual SQL artifact add service/subject reference rows, while website exposure remains a separate follow-up. | App-first service contract expansion | `toquranapp` | App production DB executed after backup/evidence; website exposure pending |
...
- Islamic Studies/Quran Literature service+subject patch: `database/manual/patches/2026-06-21-add-islamic-studies-quran-literature-services-subjects.sql` (executed in app production on 2026-06-21 after backup/evidence; website follow-up still required)
...
7. Treat Arabic Language, Islamic Studies, and Quran Literature as distinct public/app service values for website intake; do not collapse them into Quranic Arabic during the public handoff.
