          ...
          <details class="vl-context-details">
            <summary>
              ...
              @if ($selectedContextId && $teacherSubjectClass)
                <strong>
                  {{ $teacherSubjectClass->class_name ?: $teacherSubjectClass->class?->title }} - {{ \Illuminate\Support\Str::lower(trim((string) $teacherSubjectClass->subject_name)) === 'english' ? 'Quranic Arabic' : $teacherSubjectClass->subject_name }}
                </strong>
              @else
              ...
              @else
                ...
                <div class="vl-context-list">
                  @forelse ($contexts as $context)
                    @php
                      $subjectLabel = \Illuminate\Support\Str::lower(trim((string) $context->subject_name)) === 'english' ? 'Quranic Arabic' : $context->subject_name;
