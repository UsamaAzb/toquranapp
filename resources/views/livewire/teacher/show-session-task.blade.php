...
@include('livewire.teacher.partials.task-file-dropzone', [
  'inputId' => 'sessionTaskFilesInput',
  'resetKey' => ($show ? 'open' : 'closed').'-'.($isEdit ? 'edit-'.$taskId : 'create-'.$sessionId),
  'uploaderScope' => 'session-task-uploader',
  ...
  <livewire:teacher.library-picker wire:key="session-task-library-picker" />
</div>
