<div>
  ...
  <div class="modal @if($show) show @endif" tabindex="-1"
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title">
            {{ $isEdit ? 'Edit Task' : 'Add Task to Session #' . $sessionId }}
          </h5>
...
@endif
    ...
    {{-- لو النوع لينك (id=5): إظهار حقل رابط --}}
    @if($this->isLinkType)
    ...
    {{-- لو النوع يوتيوب (id=6): إظهار حقل رابط يوتيوب --}}
    ...
    @endif
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-text-secondary" wire:click="$set('show', false)">Close</button>
          <button type="button" class="btn btn-primary" wire:click="{{ $isEdit ? 'updateTask' : 'save' }}" @disabled($locked)>
