...
<div class="" id="">
    ...
    <div class="container">
         <h2 class="header-title border-color" style="font-size:25px"> The Tell Tale Heart Selection Test</h2>
...
<div class="container box-div row justify-content-center">
    ...
    <div class="col-lg-9 col-md-10 col-12 mb-3">
 	...
 	<iframe src="{{asset('public/uploads/pdfs/2- The Tell-Tale Heart Selection Test.pdf')}}"
			frameborder="0"
			marginheight="0"
			marginwidth="0"
			width="100%"
