...
@section('title', 'Friends Episodes')
@section('meta_description', 'Browse Friends episodes for language practice with familiar scenes and dialogue.')
@section('content')
...
<a   href="{{url('tv_series/'.$episode->slug)}}" >
