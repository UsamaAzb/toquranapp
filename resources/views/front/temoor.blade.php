...
<div class="" id="">
    ...
    <div class="container">
         <h2 class="header-title border-color" style="font-size:25px"> A Streetcar Name Desire</h2>
...
<source src="{{asset('public/uploads/a-streetcar-named-desire/summary.mov')}}" type="video/mp4">
</video>
